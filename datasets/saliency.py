...
class _BaseFolder(data.Dataset):
    def __init__(self, img_dir, gt_dir, img_format='jpg', gt_format='png', crop=None, rotate=None, flip=False,
                 mean=None, std=None):
        super(_BaseFolder, self).__init__()
...
class Folder(_BaseFolder):
    def __init__(self, img_dir, gt_dir, img_format='jpg', gt_format='png', size=256, training=True,
        ...
        super(Folder, self).__init__(img_dir, gt_dir, img_format, gt_format,
                                     crop=crop, rotate=rotate, flip=flip, mean=mean, std=std)
        self.size = size
