...
class _BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='%s/seg2Files'%home, help='path to save params and tensorboard files')
        self.parser.add_argument('--results_dir', type=str, default='./results/', help='saves prediction results here.')
